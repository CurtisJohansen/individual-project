...
def new_data():
    ...
    df = pd.read_excel('FY20CityComp.xlsx', index_col=0)
...
# rename columns
    ...
    df.columns = ['first_name', 'middle_name', 'last_name','employee_category', 'hire_date', 'annual_salary_2020', 'base_pay_2020', 'leave_payout_2020', 'other_2020', 'arbitration_and_settlements', 'overtime_2020', 'gross_earnings_2020', 'additional_compensation', 'total_compensation', 'job_title', 'department', 'gender', 'ethnicity', 'dept_subgroup', 'withdraw_date']
    
    
# remove salary outliers
    
    df = df[df.annual_salary_2020 < 250_000]
...
# Round columns down to just two decimal places
    ...
    cols = ['annual_salary_2020', 'base_pay_2020', 'leave_payout_2020', 'other_2020', 'arbitration_and_settlements', 'overtime_2020', 'gross_earnings_2020', 'additional_compensation', 'total_compensation']
...
# drop columns
    ...
    dropcols = ['first_name', 'middle_name', 'last_name', 'employee_category', 'dept_subgroup', 'year', 'job_title', 'hire_date', 'withdraw_date']
